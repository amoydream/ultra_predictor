                ...
                for result in results:
                    ...
                    group_writer.writerow(
                        [
                            ...
                            best_10_rounded,
                            result.runner.sex,
                            result.prediction_race.itra_point,
                            result.prediction_race.refreshment_points,
                            result.prediction_race.max_time,
                            result.prediction_race.month_of_the_race,
                            result.prediction_race.distance,
                            result.prediction_race.ascent,
                            result.prediction_race.descent,
