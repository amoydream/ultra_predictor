...
)  # (ultra_predictor/config/settings/base.py - 3 = ultra_predictor/)
APPS_DIR = ROOT_DIR.path("ultra_predictor")
...
MIGRATION_MODULES = {"sites": "ultra_predictor.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "ultra_predictor.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Mojek""", "m.mojek@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "ultra_predictor.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
PREDICTION_ML_FOLDER = "prediction_ml"
